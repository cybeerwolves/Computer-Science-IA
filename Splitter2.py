...
def run():
    ...
    BoldSplit = 'C:/Users/samue/OneDrive/Desktop/Code/IA for Computer Science/Computer-Science-IA/NeedBoldSplit/'
            ...
            for contour in contours:
                ...
                if min_length <= w <= max_length and min_width <= h <= max_width:
                    ...
                    for i in range(0, len(Color_D[0])):
                        ...
                        Color = identify_color(Color_D[0][i][0], Color_D[0][i][1], Color_D[0][i][2]) #Replace with CardFilter on submission
