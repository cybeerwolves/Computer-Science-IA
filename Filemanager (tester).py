...
Button(root, text = "Open a File", command = open_file).grid(row=10, column =2)

Button(root, text = "Copy a File", command = copy_file).grid(row = 15, column = 2)

Button(root, text = "Delete a File", command = delete_file).grid(row = 20, column = 2)

Button(root, text = "Rename a File", command = rename_file).grid(row = 25, column = 2)

Button(root, text = "Move a File", command = move_file).grid(row = 30, column =2)

Button(root, text = "Make a Folder", command = make_folder).grid(row = 35, column = 2)

Button(root, text = "Remove a Folder", command = remove_folder).grid(row = 40, column =2)

Button(root, text = "List all Files in Directory", command = list_files).grid(row = 45,column = 2)
